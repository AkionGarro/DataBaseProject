...
public class Brand extends javax.swing.JPanel {
    ...
    private  Controller_Brand controller;
    /**
     * Creates new form Brand
     */
    public Brand() {
        initComponents();
        controller=mainCont.getContBrand();
        fillTable();
    }
    ...
    private void initComponents() {
        ...
        add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 120, -1, 50));
        ...
        add(createButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(460, 130, 70, 30));

        modifyButton.setBackground(new java.awt.Color(0, 0, 0));
        modifyButton.setForeground(new java.awt.Color(255, 255, 255));
        modifyButton.setText("Modify");
        add(modifyButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(550, 130, 70, 30));
        ...
        add(nameField, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 130, 300, 30));
